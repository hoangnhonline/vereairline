                       ...
                       <div class="col-md-12" >
                          <table class="table table-bordered tbl_value">
                            <tr>
                              ...
                              <td class="value">
                                <?php if($arrDetail['status']==2) echo "Mới" ;
                                if($arrDetail['status']==1) echo "Đang xử lý" ;
                                if($arrDetail['status']==3) echo "Huỷ" ;
                                if($arrDetail['status']==4) echo "Hoàn thành" ;                                
                                ?>
                              </td>
                            </tr>
                             <tr>
                       ...
                       while($row = mysql_fetch_assoc($rs)){                        
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['product_name']; ?>
                               <?php if($row['for_id'] == 1) { ?>
                              <img src="img/ong.png" class="fmember-img" style="float:right" data-value="<?php echo $row['for_id']; ?>"/>
                              
                              <?php }elseif($row['for_id']==2){ ?>
                              <img src="img/ba.png" class="fmember-img" style="float:right" data-value="<?php echo $row['for_id']; ?>"/>
                              
                              <?php }elseif($row['for_id']==3){ ?>
                              <img src="img/cha.png" class="fmember-img" style="float:right" data-value="<?php echo $row['for_id']; ?>"/>
                              
                              <?php }elseif($row['for_id']==4){ ?>
                              <img src="img/me.png" class="fmember-img" style="float:right" data-value="<?php echo $row['for_id']; ?>"/>
                              
                              <?php }elseif($row['for_id']==5){ ?>
                              <img src="img/boy.png"  class="fmember-img" style="float:right" data-value="<?php echo $row['for_id']; ?>"/>
                                                    
                              <?php }else{ ?>
                              <img src="img/girl.png" class="fmember-img" style="float:right" data-value="<?php echo $row['for_id']; ?>"/>
                                               
                              <?php } ?>                    
                            <div class="clearfix"></div>
                              <div class="img-thumbnail circle" style="width:20px;height:20px;background-color:<?php echo $model->getColorCode($row['color_id']); ?>"></div>
                              <p>Kích thước: <?php echo $model->getSizeName($row['size_id']); ?></p>
                            </td>
